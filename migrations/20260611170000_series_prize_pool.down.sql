-- Restore the bounty-aware, single-tournament version of the function
-- (from 20260611140000_add_bounty_support) and drop the series helper.
...
DROP FUNCTION IF EXISTS apply_tournament_payout(UUID, INTEGER, INTEGER);
