...
INSERT INTO tournaments (id, club_id, name, description, start_time, end_time, buy_in_cents, seat_cap) VALUES
    -- Poker One (Charleroi) - 7 tournaments
    -- 3 Completed tournaments
    ('10001111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'Monday Night Madness', 'Weekly freezeout', NOW() - INTERVAL '10 days', NOW() - INTERVAL '9 days', 2500, 40),
    ('10002222-2222-2222-2222-222222222222', '66666666-6666-6666-6666-666666666666', 'Tuesday Turbo', 'Fast-paced action', NOW() - INTERVAL '8 days', NOW() - INTERVAL '7 days', 3000, 30),
    ('10003333-3333-3333-3333-333333333333', '66666666-6666-6666-6666-666666666666', 'Wednesday Warriors', 'Mid-week grind', NOW() - INTERVAL '5 days', NOW() - INTERVAL '4 days', 4000, 50),
    -- 1 Live tournament
    ('10004444-4444-4444-4444-444444444444', '66666666-6666-6666-6666-666666666666', 'Thursday Live Event', 'Currently running', NOW() - INTERVAL '2 hours', null, 3500, 35),
    -- 3 Upcoming tournaments
    ('10005555-5555-5555-5555-555555555555', '66666666-6666-6666-6666-666666666666', 'Friday Fortune', 'Weekend starter', NOW() + INTERVAL '2 days', null, 4500, 45),
    ('10006666-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 'Saturday Slam', 'Big weekend event', NOW() + INTERVAL '5 days', null, 5000, 60),
    ('10007777-7777-7777-7777-777777777777', '66666666-6666-6666-6666-666666666666', 'Sunday Special', 'Weekly finale', NOW() + INTERVAL '8 days', null, 2000, 40),

    -- Liège Poker Club - 7 tournaments
    -- 3 Completed tournaments
    ('20011111-1111-1111-1111-111111111111', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Liège Monday Classic', 'Classic format', NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days', 3000, 40),
    ('20012222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Tuesday Deepstack', 'Long structure', NOW() - INTERVAL '9 days', NOW() - INTERVAL '8 days', 4000, 30),
    ('20013333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Wednesday Rebuy', 'Rebuy allowed', NOW() - INTERVAL '6 days', NOW() - INTERVAL '5 days', 2500, 50),
    -- 1 Live tournament
    ('20014444-4444-4444-4444-444444444444', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Thursday Live Action', 'Currently playing', NOW() - INTERVAL '1 hour', null, 4500, 25),
    -- 3 Upcoming tournaments
    ('20015555-5555-5555-5555-555555555555', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Friday Night Fever', 'Popular weekly', NOW() + INTERVAL '3 days', null, 5000, 45),
    ('20016666-6666-6666-6666-666666666666', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Saturday Superstack', 'Deep stacks', NOW() + INTERVAL '6 days', null, 3500, 60),
    ('20017777-7777-7777-7777-777777777777', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Sunday Series', 'Series event', NOW() + INTERVAL '9 days', null, 2000, 40),

    -- Pokah Room Antwerp - 7 tournaments
    -- 3 Completed tournaments
    ('30021111-1111-1111-1111-111111111111', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Antwerp Ace', 'Monday special', NOW() - INTERVAL '11 days', NOW() - INTERVAL '10 days', 3500, 35),
    ('30022222-2222-2222-2222-222222222222', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Tuesday Tornado', 'Turbo format', NOW() - INTERVAL '7 days', NOW() - INTERVAL '6 days', 4500, 25),
    ('30023333-3333-3333-3333-333333333333', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Wednesday Wonder', 'Mid-week action', NOW() - INTERVAL '4 days', NOW() - INTERVAL '3 days', 3000, 45),
    -- 1 Live tournament
    ('30024444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Thursday Thunder', 'High energy live', NOW() - INTERVAL '3 hours', null, 4000, 30),
    -- 3 Upcoming tournaments
    ('30025555-5555-5555-5555-555555555555', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Friday Fiesta', 'Party atmosphere', NOW() + INTERVAL '1 day', null, 3750, 50),
    ('30026666-6666-6666-6666-666666666666', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Saturday Showdown', 'Weekend highlight', NOW() + INTERVAL '4 days', null, 5000, 70),
    ('30027777-7777-7777-7777-777777777777', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Sunday Summit', 'Weekly climax', NOW() + INTERVAL '7 days', null, 2500, 45);
